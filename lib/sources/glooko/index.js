...
function glookoSource (opts, axios) {
  ...
  var impl = {
    ...
    dataFromSesssion (session, last_known) {
      ...
      let v3APIURL = Defaults.v3API.replace('_PATIENT_',session.user.userLogin.glookoCode).replace('_STARTDATE_', dateString - "T23:59:59.999Z").replace('_ENDDATE_', dateString + 'T23:59:59.999Z');
